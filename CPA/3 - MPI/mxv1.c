...
/**********************************************************************************************************/
   ...
   * y enviar la x inicial a todos */
    MPI_Bcast 	( x, n, MPI_DOUBLE, 0, MPI_COMM_WORLD );							// Bcast de X
    MPI_Scatter	( M, tama, MPI_DOUBLE, Mloc, tama, MPI_DOUBLE, 0, MPI_COMM_WORLD );	// Scatter de M
    MPI_Scatter ( v, tama, MPI_DOUBLE, vloc, tama, MPI_DOUBLE, 0, MPI_COMM_WORLD );	// Scatter de v
